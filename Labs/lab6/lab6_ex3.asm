...
.ORIG x3400
	...
	SUB_IS_PALINDROME_3400
		...
		LD R6, SUB_TO_UPPER_PTR_3400 ;calling subroutine within subroutine
		JSRR R6
...
.ORIG x3600
	...
	SUB_TO_UPPER_3600
		...
		CONVERSION_LOOP_3600
			LDR R0, R1, #0 ; load what's at r1 to r0
			ADD R0, R0, #0 ; check if it's 0 aka newline
			BRz END_CONVERSION_LOOP_3600 ; ends loop if newline is hit
			
			AND R0, R0, R2 ;using bitmasking
			STR R0, R1, #0
